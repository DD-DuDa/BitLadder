...
struct Flash_fwd_params : public Qkv_params {
    ...
    // The dimensions.
    int b, seqlen_q, seqlen_k, seqlen_k_pack, seqlen_knew, seqlen_k_params, d, d_kpack, d_vpack, d_vparams,seqlen_q_rounded, seqlen_k_rounded, d_rounded, rotary_dim;
...
template<typename T, int Headdim, int quant_mode, int num_bits, int group_size> 
void run_kvcache_qpack_(Flash_fwd_params &params, cudaStream_t stream);
